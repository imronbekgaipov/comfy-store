      ...
      {data && (
        <div className="align-element mt-20 grid lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="dark:text-[#F0F6FF] mb-6">${data.attributes.price}</p>
            <h2 className="leading-7 mb-4">{data.attributes.description}</h2>
            <div>
              <h4>Colors:</h4>
            ...
            <div className="form-control w-full max-w-xs">
              ...
              <select
                ...
                className="select select-primary border-indigo-600 mb-7 select-md"
                id="amount"
              >
            ...
            <div className="mb-10">
              <button
                onClick={addToCart}
                className="btn btn-primary rounded-md bg-pink-600 px-2 py-1  text-white hover:bg-pink-700 md:px-3 md:py-2"
              >
                ADD TO BAG
              </button>
            </div>

  ...
  return (
    <div className="align-element py-20">
      <div className="flex flex-wrap gap-2 sm:gap-x-6 items-center justify-center">
        <h1 className="text-4xl font-bold leading-none text-gray-700 tracking-tight sm:text-6xl">
          We love
        </h1>
        <div className="stats bg-primary shadow">
          <div className="stat">
            <div className="stat-title rounded-md bg-blue-600 px-2 py-2  text-white md:px-3 md:py-2 text-4xl font-bold tracking-widest">
              comfy
            </div>
          </div>
        </div>

  ...
  return (
    <div>
      <div className="align-element border-b border-base-300 mt-20 mb-14">
        <h2 className="text-3xl font-medium tracking-wider capitalize mb-5">
          Featured Products
        </h2>
      </div>
              ...
              <Link to={`/material/${item.id}`}>
                <div className="card w-80 bg-base-100 shadow-xl rounded-xl">
                  ...
                  <div className="card-body items-center text-center mt-5">
                    <h2 className="card-title capitalize tracking-wider text-2xl mb-2">
                      {item.attributes.title}
                    </h2>
                    <p className="text-secondary">${item.attributes.price}</p>
                  </div>
                </div>
              </Link>
            </li>

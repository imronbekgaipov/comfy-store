...
function ProductNavbar() {
  ...
  return (
    <form className="align-element mt-10 grid relative  sm:grid-cols-2 md:grid-cols-3 rounded-md lg:grid-cols-4 p-5 gap-5">
      <div>
        <label htmlFor="price" className="dark:text-[#F0F6FF]">
          Serarch Product
        </label>
        <br />
        <input
      ...
      <div>
        <label className="dark:text-[#F0F6FF]" htmlFor="sort">
          Sort By{" "}
        </label>
        <br />
        <select
      ...
      <div>
        ...
        <br />
        <input className="w-56" type="range" min={100} max={100000} />
        <div className="flex items-center gap-24">
          <p className="dark:text-[#F0F6FF]">0</p>
          <p className="text-center dark:text-[#F0F6FF]">Max : $1,000.00</p>
        </div>
      </div>
      <div class="form-control items-center flex-col">
        ...
        <input
          type="checkbox"
          name="shipping"
          class="checkbox checkbox-sm checkbox-accent rounded-xl"
        />
      </div>
      <div className="flex gap-20 items-center">
        <button
          ...
          className="w-full btn btn-sm btn-info rounded-xl bg-blue-600 px-2 py-1  text-white hover:bg-blue-700 md:px-3 md:py-2"
        >
          SEARCH
        </button>
      </div>
      <div className="flex gap-20 items-center">
        <button
          onClick={handleReset}
          className="w-full btn btn-secondary btn-sm rounded-xl bg-pink-500 px-2 py-1  text-white hover:bg-pink-600 md:px-3 md:py-2"
        >
          RESET
        </button>
      </div>
